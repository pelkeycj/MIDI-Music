...
public class MusicReader {
   ...
   * @return a CompositionBuilder with notes added
   */
  public static <T> T parseFile(Readable readable, CompositionBuilder<T> piece) {
    ...
    while (scanner.hasNext()) {
      ...
      switch (lineType) {
        ...
        case "note":
          try {
            ...
            try {
              ...
              System.out.println("bad note: " + startBeat + ", " + endBeat);
            }
          } catch (NoSuchElementException e) {
        ...
        case "repeat":
          try {
            int firstBeat = scanner.nextInt();
            int lastBeat = scanner.nextInt();
            try {
              piece.addRepeat(firstBeat, lastBeat);
            } catch (IllegalArgumentException e) {
              System.out.println("bad repeat: " + firstBeat + ", " + lastBeat);
            }
          } catch (NoSuchElementException e) {
